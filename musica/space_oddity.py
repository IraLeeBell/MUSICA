...
# Melody for "Space Oddity" (simplified beep-tone adaptation)
MELODY = [
    'G', 'A', 'B', 'C', 'REST', 'C', 'B', 'A', 'G', 'REST',
    'G', 'A', 'B', 'G', 'REST', 'A', 'B', 'C', 'REST',
    'C', 'B', 'A', 'G', 'REST', 'D', 'E', 'F', 'G', 'REST'
]
DURATIONS = [
    0.4, 0.4, 0.4, 0.8, 0.2, 0.4, 0.4, 0.4, 0.8, 0.2,
    0.4, 0.4, 0.4, 0.8, 0.2, 0.4, 0.4, 0.8, 0.2,
    0.4, 0.4, 0.4, 0.8, 0.2, 0.4, 0.4, 0.4, 0.8, 0.2
]
